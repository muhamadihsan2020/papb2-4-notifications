package apps.muhamadihsan.notificationproject;
...
public class MainActivity extends AppCompatActivity {
    ...
    private Button mNotifButton, mUpdateButton, mCancelButton;
    ...
    private void sendNotification(){
        ...
        built.addAction(R.drawable.ic_learn_more, "Learn More", pendingLearnMoreIntent);
        built.addAction(R.drawable.ic_update, "UPDATE", pendingUpdateIntent);
